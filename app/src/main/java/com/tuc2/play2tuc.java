 ...
 */
public class play2tuc extends Activity {
    TableLayout layout;
    int bordsize=8;
    boolean turn = false;
...
int movecounter=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // setContentView(R.layout.tuc_graphic);
        ...
        final LinearLayout lm = (LinearLayout) findViewById(R.id.dnm3);
    ...
    private class PlayOnClick implements View.OnClickListener {
        ...
        public void onClick(View view){
            if (view instanceof Button) {
                ...
                movecounter++;
               // B.setText(turn ? "O" : "X");
                B.setBackgroundResource(turn? R.drawable.nought:R.drawable.crssgloss);
                B.setEnabled(false);
                if(turn)
                {
                    score2+=ch3(b,x,y);
                ...
                if(w==1)
                {
                    Intent i = new Intent(play2tuc.this,winner.class);
                    Bundle b = new Bundle();
